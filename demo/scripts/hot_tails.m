...
%------------------------------------------------------------------------------|
%   Load v_c/v_th0 and tau
%------------------------------------------------------------------------------|
data = load('tmp_var.dat', '-ascii');
delete 'tmp_var.dat';
...
fprintf(fileID,'\n');
for i = 1:length(time)
    fprintf(fileID,'%19.12e ', time(i), Ht(i), n(i), T(i), Epar(i), data(i,1), data(i,2));
    fprintf(fileID,'\n');
end
fclose(fileID);
